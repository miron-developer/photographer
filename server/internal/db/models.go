...
type PhotoProject struct {
	...
	CreatedAt              uint        `json:"created_at" gorm:"autoCreateTime:nano"`
	UpdatedAt              uint        `json:"updated_at" gorm:"autoUpdateTime:nano"`
	SelectedCollectionIds  []uint      `json:"selected_collection_ids"`
	SuggestedCollectionIds []uint      `json:"suggested_collection_ids" gorm:"not null"`
	CustID                 uint        `json:"cust_id"`
	Customer               Customer    `gorm:"not null;foreignKey:CustID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
...
type PhotoCollection struct {
	...
	// if belong to the certain project
	ProjectID    uint         `json:"project_id"`
	PhotoProject PhotoProject `gorm:"foreignKey:ProjectID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
}
...
type Photo struct {
	...
	PhotoCollection PhotoCollection `gorm:"not null;foreignKey:CollectionID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
}
...
type Link struct {
	...
	Customer     Customer     `gorm:"not null;foreignKey:CustID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
	ProjectID    uint         `json:"project_id"`
	PhotoProject PhotoProject `gorm:"not null;foreignKey:ProjectID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
}
